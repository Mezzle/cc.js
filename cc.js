// Updated version of Cookieclicker Bots (http://cookieclicker.wikia.com/wiki/Cookieclicker_Bots)
...
function Controller () {
    ...
    this.actions = {
        ...
        spawngold: { delay:    0, func: function () { Game.goldenCookie.time = Game.goldenCookie.maxTime; } },
        wrinkler:  { delay:   50, func: function () { for ( var i = 0; i < Game.wrinklers.length; i++ ) { if (Game.wrinklers[i].close==1) { Game.wrinklers[i].hp-- } } } },
    };
...
var view = {
    ctrl: new Controller,
    actions: {
        65 /* A */: 'autobuy', /* auto calculate and buy buildings/upgrades */
        67 /* C */: 'spawngold', /* spawn a golden cookie */
        90 /* Z */: 'oneshot', /* ? supposed buy the next best as a one time thing ? */
        72 /* H */: 'season', /* ? click seasonal related stuff */
        71 /* G */: 'gold', /* autoclick gold cookies */
        78 /* N */: 'gnotify', /* beep when a gold cookie appears */
        70 /* F */: 'frenzy', /* autoclick during a frenzy*/
        77 /* M */: 'main', /* autoclicker */
        83 /* S */: 'status', /* output status of autobuy (appears to be broken ?) */
        80 /* P */: 'protect', /* protect cookies from autobuy for frenxy (?) */
        87 /* W */: 'wrinkler', /* autopop wrinklers */
    },
};
